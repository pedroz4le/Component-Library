...
<div class="rounded-lg bg-theme-purple-lighter p-4 m-8 text-white shadow-lg">
  <p><b>Alert:</b> You have just earned 5 reward points!</p>
</div>

<pre><code class="html overflow-auto my-8">&lt;div class=&quot;rounded-lg bg-theme-purple-lighter p-4 m-8 text-white shadow-lg&quot;&gt;
  &lt;p&gt;&lt;b&gt;Alert:&lt;/b&gt; You have just earned 5 reward points!&lt;/p&gt;
&lt;/div&gt;
</code></pre>
...
<div class="rounded-lg bg-theme-redish-light p-4 m-8 text-white shadow-lg">
  <p><b>Notice:</b> Your storage is full. Upgrade your plan to a higher storage capacity.</p>
</div>

<pre><code class="html overflow-auto my-8">&lt;div class=&quot;rounded-lg bg-theme-redish-light p-4 m-8 text-white shadow-lg&quot;&gt;
  &lt;p&gt;&lt;b&gt;Notice:&lt;/b&gt; Your storage is full. Upgrade your plan to a higher storage capacity.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
