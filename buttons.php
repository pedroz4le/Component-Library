...
<h2 class="font-thin pb-4">Pill Button</h2>
...
<div class="border border-grey-dark mb-8 mx-auto overflow-hidden rounded max-w-lg">
	<div class="border-b border-grey-dark p-8 text-center">
		<a class="bg-red font-bold inline-block hover:bg-red-lighter no-underline px-8 py-4 rounded-full shadow-sm text-lg text-white tracking-wide" href="#">
