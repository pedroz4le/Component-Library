...
<div class="flex items-center justify-between mx-auto w-1/2">
  <a href="#" class="hover:font-bold no-underline p-4 rounded-full text-black text-4xl">&laquo;</a>
  ...
  <a href="#" class="bg-theme-redish-light hover:bg-grey-light no-underline p-4 rounded-full text-black text-lg">3</a>
  ...
  <a href="#" class="hover:font-bold no-underline p-4 rounded-full text-black text-4xl">&raquo;</a>
</div>

<pre><code class="html overflow-auto my-8">&lt;div class=&quot;flex items-center justify-between mx-auto w-1/2&quot;&gt;
  &lt;a href=&quot;#&quot; class=&quot;hover:font-bold no-underline p-4 rounded-full text-black text-4xl&quot;&gt;&amp;laquo;&lt;/a&gt;
  &lt;a href=&quot;#&quot; class=&quot;hover:bg-grey-light no-underline p-4 rounded-full text-black text-lg&quot;&gt;1&lt;/a&gt;
  &lt;a href=&quot;#&quot; class=&quot;hover:bg-grey-light no-underline p-4 rounded-full text-black text-lg&quot;&gt;2&lt;/a&gt;
  &lt;a href=&quot;#&quot; class=&quot;bg-theme-redish-light hover:bg-grey-light no-underline p-4 rounded-full text-black text-lg&quot;&gt;3&lt;/a&gt;
